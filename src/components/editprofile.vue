<template>
  <div class="editProfile">
    ...
    <b-card v-if="p" bg-variant='dark' text-variant="light" style="max-width:1000px;margin:auto;" header-bg-variant="info" border-variant="info">
       <template v-slot:header>
     <i class="fas fa-user-cog no-hover-header"></i>Your Profile
    </template>
      ...
      <b-row>
        ...
        <b-col>
          ...
          <multi-select
            ...
            :selected-options="removedChamps"
      ...
      <b-form-group>
        <b-row style="padding-bottom:1rem">
          <b-col lg="2" class="py-1" style="text-align:left;">
            <label for="youracc">Add Accounts:</label>
          </b-col>
          <b-col lg="4" class="py-1">
            <b-form-input id="youracc" v-model="account" placeholder="Account Name"></b-form-input>
          </b-col>
          ...
          <b-col lg="4">
            <b-button variant="success" block v-on:click="updateAccounts"><i class="fas fa-user-plus textIcon"></i>Add Account</b-button>
          </b-col>
        </b-row>
        <b-row style="padding-bottom:1rem">
          <b-col lg="2" style="text-align:left;">
            <label for="youracc">
              ...
              <i
                ...
                v-b-tooltip.hover
                title="Click one to add!"
              ></i>
            </label>
          </b-col>
          <b-col style="text-align:left;">
            <i
              v-on:click="socialsAdd(social)"
              v-for="social in socialsOptions"
              :class="'fab fa-' + social +' biggerTextIcon'"
              :id="social"
              v-b-tooltip.hover
                :title="social[0].toUpperCase() + social.slice(1)"
                :key="social"
            ></i>
          </b-col>
        </b-row>
      ...
      <div style="display:flex;">
        <b-container style="width:50%;">
          <b-row style="align-items: center;">
            <b-col lg="12" class="border border-dark rounded">
              <h5>
                Your Accounts
                <i
                  class="fas fa-question-circle textIcon"
                  v-b-tooltip.hover
                  title="Click an account to assign a main"
                ></i>
              </h5>
            </b-col>
          </b-row>
          <b-row
            style="align-items: center;height:54.5px;"
            class="py-1 accounts border border-dark rounded"
            v-on:click="setMainAccount(a.id)"
            :key="a.id"
            v-for="a in accountList"
          >
            <b-col lg="12" style="text-align:left;">
              {{a.name}}
              <b-badge class="mx-1" variant="info">{{a.region.toUpperCase()}}</b-badge>
              <b-badge class="mx-1" v-if="a.id == mainAccount" variant="success">Main</b-badge>
              <i
                style="font-size:20px;"
                :value="a.id"
                class="fas fa-trash-alt red delete px-1"
                :v-model="a.id"
                v-on:click="deleteRow(a, 'account')"
              ></i>
            </b-col>
          </b-row>
        </b-container>
        <b-container style="width:50%;">
            ...
            <b-col lg="12" class="border border-dark rounded">
              <h5>
                ...
                <i
                  class="fas fa-question-circle textIcon"
                  v-b-tooltip.hover
                  title="No URL required - just type in your username!"
                ></i>
              </h5>
            </b-col>
          </b-row>
          ...
          >
            <b-col lg="1">
              <i style="padding-left:0;" :class="'fab fa-' + socials + ' no-hover py-1'"></i>
            </b-col>
            <b-col lg="10" style="align-items: center;">
              ...
              <b-form-input
                ...
                v-if="socials == 'twitch'"
                v-model="twitch"
                :placeholder="'Your ' + socials.replace(/^\w/, c => c.toUpperCase())"
              ></b-form-input>
              <b-form-input
                class="mx-2"
            ...
            <b-col style="text-align:left;padding:.4rem;" lg="1">
              <i
                style="font-size:24px;"
                :value="socials"
                class="fas fa-trash-alt red delete"
                v-on:click="deleteRow(socials, 'social')"
              ></i>
            </b-col>
          </b-row>
        </b-container>
      ...
      <b-row class="py-2">
        <b-col lg="2" style="text-align:left;">
          <label for="yourroles">Your Roles:</label>
        </b-col>
        <b-col style="text-align:left;">
      ...
      <b-row style="align-items: center;">
        <b-col lg="2" style="text-align:left;">
          <label for="yourlang">Language(s):</label>
        </b-col>
        <b-col lg="2" style="text-align:left;">
          <b-form-select
            id="yourlang"
            v-on:change="addLang(selectedLang)"
        ...
        <b-col lg="8" style="text-align:left;">
          <b-badge
            v-on:click="removeLang(l)"
            class="mx-1 lang"
            :key="l"
            v-for="l in languages"
            variant="primary"
          >{{l.toUpperCase()}}</b-badge>
        </b-col>
      </b-row>
      ...
      <span v-if="mentor=='mentor'">
        ...
        <b-row>
          <b-col lg="2" style="text-align:left;">
            <label for="aboutme">Your Bio:</label>
          </b-col>
          <b-col>
            <b-form-textarea
              id="aboutme"
          ...
          <b-col lg="2" style="text-align:left;">
            <label for="aboutme">
              ...
              <i
                class="fas fa-question-circle textIcon"
                v-b-tooltip.hover
                title="Seperate achievements by comma"
              ></i>
            </label>
          </b-col>
          <b-col>
...
Beat Doublelift in arm wrestling"
        ...
        <b-row>
          <b-col lg="2" style="text-align:left;">
            <label for="yourreview">Review Types:</label>
          </b-col>
          <b-col style="text-align:left;">
            <b-form-checkbox-group
              id="yourreview"
        ...
        <b-row>
          <b-col lg="2" style="text-align:left;">
            <label for="yourmoney">Free/Paid:</label>
          </b-col>
          <b-col style="text-align:left;">
            <b-form-checkbox-group
              id="yourmoney"
        ...
        <b-row>
          <b-col lg="2" style="text-align:left;">
            <label for="yourreq">Add Requirement:</label>
          </b-col>
        ...
        <b-row style="width:55%;align-items: center;" class="py-1">
          <b-col lg="12" class="border border-dark rounded">
        ...
        <span :key="key" v-for="(value, key) in requirements">
          <b-row
            v-if="value != null && (value == true || value.enabled == true)"
            style="width:55%;text-align:left;"
            class="py-1 accounts border border-dark rounded"
          >
            <b-col v-if="key=='roleMatch' && value==true">
              Role Match
              <i
                class="fas fa-question-circle textIcon"
                v-b-tooltip.hover
                title="If any roles match - pass."
              ></i>
              <i
                style="font-size:24px;"
                :value="key"
                class="fas fa-trash-alt red delete"
                v-on:click="deleteReq(key)"
              ></i>
            </b-col>
            <b-col v-if="key=='serverMatch' && value==true">
              Server Match
              <i
                class="fas fa-question-circle textIcon"
                v-b-tooltip.hover
                title="If any servers match - pass."
              ></i>
              <i
                style="font-size:24px;"
                :value="key"
            ...
            <b-col v-if="key=='champMatch' && value==true">
              Champ Match
              <i
                class="fas fa-question-circle textIcon"
                v-b-tooltip.hover
                title="If any champs match - pass."
              ></i>
              <i
                style="font-size:24px;"
                :value="key"
            ...
            <b-col v-if="key=='langMatch' && value==true">
              Language Match
              <i
                class="fas fa-question-circle textIcon"
                v-b-tooltip.hover
                title="If any languages match - pass."
              ></i>
              <i
                style="font-size:24px;"
                :value="key"
      ...
      <b-row v-if="mentor=='student'">
        <b-col lg="2" style="text-align:left;">
          <label for="yourgoals">Your Goals:</label>
        </b-col>
      ...
      <b-row class="py-2">
        <b-col>
          <b-button
            v-if="this.$route.query.new == '1'"
            v-on:click="setData"
            variant="info"
            block
          ><i class="fas fa-user-plus textIcon"></i>Create your Profile</b-button>
          <b-button
            v-if="this.$route.query.new != '1'"
            v-on:click="setData"
            variant="info"
            block
          ><i class="fas fa-wrench textIcon"></i>Update Information</b-button>
        </b-col>
      </b-row>
    </b-card>
  </div>
  ...
  methods: {
    ...
    onSelect (items, lastSelectItem) {
      if (this.removedChamps.length == 0) {
        this.main = lastSelectItem.value;
      }
      if (
        this.removedChamps.length <= 5 &&
        this.champions.includes(lastSelectItem.value) &&
        !this.removedChamps.includes(lastSelectItem.value)
      ) {
        this.removedChamps.push(lastSelectItem.value);
      ...
      } else if (this.removedChamps.includes(lastSelectItem.value)) {
        this.makeToast(
          "Error",
      ...
      this.champs = lastSelectItem.value;
    },
      ...
      if (this.account && this.region) {
        for (let x of this.accountList) {
          ...
          if (
            ...
            x.name.toLowerCase() == this.account.toLowerCase()
          ) {
            this.makeToast(
              "Error",
    ...
    socialsAdd: function(sm) {
      if (this.socialsList.includes(sm)) {
        this.makeToast(
          "Error",
          "You can only have one of each social media.",
          "danger"
        );
      } else {
    ...
    addLang: function(lang) {
      if (!this.languages.includes(lang)) {
        ...
        this.makeToast(
          "Error",
          "You cannot add the same language twice.",
          "danger"
        );
      }
    ...
    addReq: function() {
      if (
        ...
        this.requirements[this.selectedReq].enabled == true
      ) {
        this.makeToast(
          "Warning",
        ...
        if (
          this.selectedReq == "roleMatch" ||
          this.selectedReq == "champMatch" ||
          this.selectedReq == "serverMatch" ||
          this.selectedReq == "langMatch"
        ) {
          this.requirements[this.selectedReq] = true;
        } else if (this.selectedReq == "gamesPlayed") {
          this.requirements[this.selectedReq] = {
            enabled: true,
    ...
    setData: function() {
      ...
      if (this.$parent.$parent.profileData.type == "mentor") {
        if (
          this.requirements.gamesPlayed &&
          this.requirements.gamesPlayed.enabled == true
        ) {
          this.requirements.gamesPlayed = {
            enabled: true,
            games: this.totalGames,
      ...
      axios
        .post(path, Object.assign({}, data, data2))
        .then(response => {
