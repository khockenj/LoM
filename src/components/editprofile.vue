...
<b-container style="max-width:1000px">
    ...
    <b-row>
    <b-col lg="12" style="text-align:left;"><h2>League Stuff</h2></b-col>
    </b-row>
    <b-row>
      <b-col lg="2"  style="text-align:left;">    
    <label for="yourchamps"><h5>Your champions:</h5></label>
    </b-col>
    <b-col lg="10">
...
<b-form-group>
  <b-row>
    <b-col lg="2" style="text-align:left;"><label for="youracc"><h5>Your accounts:</h5></label></b-col>
  ...
  <b-row>
    <b-col lg="2" style="text-align:left;"><label for="yoursocials"><h5>Your socials:</h5></label></b-col>
    <b-col>
