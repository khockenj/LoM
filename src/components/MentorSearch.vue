    ...
    <div class="searchBarContainer">
      <b-input-group>
        ...
        <template v-slot:append>
          <b-form-select
            class="btn"
            style="color:#6c757d!important;width:240%;"
            size="lg"
            v-model="champFilter"
          ...
          <b-form-select
            class="btn"
            style="color:#6c757d!important;width:100%;"
            size="lg"
            v-model="roleFilter"
            :options="roleOptions"
            v-on:input="searchFunction"
          ...
          <b-form-select
            class="btn"
            style="color:#6c757d!important;width:200%;"
            size="lg"
            v-model="rankFilter"
            :options="rankOptions"
            v-on:input="searchFunction"
          ...
          <b-form-select
            class="btn"
            style="color:#6c757d!important;width:110%;"
            size="lg"
          ...
          <b-form-select
            class="btn"
            style="color:#6c757d!important;width:150%;"
            size="lg"
          ...
          <b-form-select
            class="btn"
            style="color:#6c757d!important;width:70%"
            size="lg"
            v-model="moneyFilter"
    ...
    searchFunction: function() {
      ...
      vm.list.forEach(function(x) {
        if (
          ...
          (vm.languageFilter == null ||
            x.languages.includes(vm.languageFilter)) &&
